              ...
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button className="h-10 flex items-center justify-center group">
                    <div
                      className={`w-full h-full flex flex-row items-center justify-start pl-1 gap[10px] ${
                        selected ? "bg-principal text-white" : "group-hover:bg-principal group-hover:text-white"
                      } transition-all`}
                    >
