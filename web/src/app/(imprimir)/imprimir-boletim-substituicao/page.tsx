                    ...
                    <div className="w-full overflow-x-auto border border-gray-200">
                        <table className="min-w-full border text-center text-sm font-light border-neutral-500">
                            <thead className="border-b font-medium border-neutral-500">
                                <tr>
                                    <th scope="col" className="text-start border-r pl-4 pr-2 py-2 border-neutral-500">NOME</th>
                                    <th scope="col" className="text-start border-r pl-4 pr-2 py-2 border-neutral-500">FORMAÇÃO</th>
                                    <th scope="col" className="text-start border-r pl-4 pr-2 py-2 border-neutral-500">DIAS TRABALHADOS</th>
                                    <th scope="col" className="text-start border-r pl-4 pr-2 py-2 border-neutral-500">TOTAL A PAGAR</th>
                                    <th scope="col" className="text-start border-r pl-4 pr-2 py-2 border-neutral-500">OBSERVAÇÕES</th>
                                </tr>
                            </thead>
                                            ...
                                            <>
                                                ...
                                                <td className="items-center h-full px-4 font-medium text-gray-900 border-r border-neutral-500">
                                                    <div className="grid grid-cols-report-teacher">
                                                        ...
                                                        <div className={`h-auto break-inside-avoid flex flex-row items-center justify-start px-2 gap-1 ${index !== info.datesWork.length - 1 && (index === 0 || index % 4 !== 0) ? "border-r border-neutral-500" : ""}`}>
