            ...
            <div className="w-full md:w-[80%] h-full flex flex-col justify-between gap-12 px-6 md:pl-0">
              ...
              <section className="w-full h-auto xl:h-4/6 flex flex-col justify-center gap-16 md:gap-8 2xl:gap-24">
                <Link
                  ...
                  className="w-full h-auto flex flex-row px-2 gap-5 hover:shadow-xl"
                >
                  ...
                  <div className="w-full h-full flex flex-col gap-3 text-[#4F4F4F]">
                    ...
                    <span className="text-sm">
                      O controle de aulas eventuais de aulas no dashboard
                      permite registrar, editar e excluir informações sobre as
                      aulas.
                    </span>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="w-full h-full flex flex-col gap-3 text-[#4F4F4F]">
                    ...
                    <span className="text-sm">
                      O cadastro de escolas é uma funcionalidade essencial do
                      projeto que permite adicionar e gerenciar informações
                      sobre as instituições educacionais.
                    </span>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="w-full h-full flex flex-col gap-3 text-[#4F4F4F]">
                    ...
                    <span className="text-sm">
                      Com o cadastro de professores, você pode manter um
                      registro completo dos docentes, facilitando a atribuição
                      de disciplinas, controle de carga horária e comunicação
                      eficiente dentro da instituição educacional.
                    </span>
                  </div>
                </Link>
              </section>
